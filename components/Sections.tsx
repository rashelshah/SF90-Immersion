                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {specs.map((spec, i) => (
                        <motion.div
                            ...
                            className="relative p-6 md:p-8 bg-gradient-to-br from-black/80 via-carbon-gray/50 to-black/60 border border-white/10 hover:border-ferrari-red/60 transition-all group overflow-hidden transform-gpu"
                        >
                            {/* Animated gradient on hover */}
                            <motion.div
                                className="absolute inset-0 bg-gradient-to-br from-ferrari-red/0 via-ferrari-red/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                            ></motion.div>

                            {/* Top corner accent */}
                            <div className="absolute top-0 left-0 w-12 h-12 border-l-2 border-t-2 border-ferrari-red/30 group-hover:border-ferrari-red transition-colors"></div>

                            {/* Content */}
                            <div className="relative z-10">
                                <h4 className="text-xs font-rajdhani text-metal-silver mb-4 tracking-[0.3em] uppercase group-hover:text-ferrari-red transition-colors">
                                    {spec.label}
                                </h4>
                                <div className="flex items-baseline gap-2">
                                    <motion.span
                                        whileHover={{ scale: 1.05 }}
                                        className="text-5xl md:text-6xl font-orbitron font-bold text-white"
                                    >
                                        {spec.value}
                                    </motion.span>
                                    <span className="text-xl md:text-2xl font-orbitron text-ferrari-red">{spec.unit}</span>
                                </div>
                            </div>
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-ferrari-red/60 via-ferrari-red/30 to-transparent origin-left"
                            ></motion.div>

                            {/* Number indicator */}
                            <div className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center border border-white/10 text-white/20 font-orbitron text-xs">
                    ...
                    {stats.map((stat, i) => (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="text-4xl md:text-5xl font-orbitron font-bold text-ferrari-red mb-2">{stat.year}</div>
                                <div className="text-lg md:text-xl font-orbitron text-white">{stat.title}</div>
                            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {technologies.map((tech, i) => (
                        ...
                        >
                            ...
                            {/* Content */}
                            <div className="relative z-10">
                                <h3 className="text-xl md:text-2xl font-orbitron font-bold mb-4 text-white group-hover:text-ferrari-red transition-colors">
                                    {tech.title}
                                </h3>
                                <p className="text-sm md:text-base font-rajdhani text-metal-silver leading-relaxed">
                                    {tech.desc}
                                </p>
                            </div>
...
export function Footer() {
    return (
        <footer className="bg-ferrari-black py-12 border-t border-white/10">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="font-orbitron font-bold text-2xl tracking-widest text-white">FERRARI</div>
                <div className="flex gap-8 text-sm font-rajdhani tracking-wider text-metal-silver">
                    <a href="#" className="hover:text-ferrari-red transition-colors">MODELS</a>
                    <a href="#" className="hover:text-ferrari-red transition-colors">RACELINE</a>
                    <a href="#" className="hover:text-ferrari-red transition-colors">UNIVERSE</a>
                    <a href="#" className="hover:text-ferrari-red transition-colors">STORE</a>
                </div>
                <div className="text-xs text-metal-silver/50 font-rajdhani">
                    © 2024 FERRARI S.p.A
                </div>
            </div>
        </footer>
